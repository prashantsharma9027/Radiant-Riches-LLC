...
const Navbar = () => {
  ...
  return (
    <div className="bg-[#212731]">
      <div className="w-[1006px] h-[64px] flex justify-between items-center px-4 md:px-0 mx-auto">
        <div className="w-1/2 flex ">
            <div className="flex ml-48 items-center bg-white md:w-[235px] h-[37px] rounded-md ">
              <svg
                className="ml-2"
                width="24"
                height="24"
        ...
        <div className="flex w-1/2 mr-8   text-[#D1D6DA]">
        ...
        <div onClick={handleBrgur} className="text-[#D1D6DA] md:hidden flex items-center relative left-12">
          <RxHamburgerMenu />
        </div>
      </div>
      {show && (
