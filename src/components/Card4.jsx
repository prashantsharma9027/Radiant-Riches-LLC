...
export const Card4 = () => {
  return (
    <div className="my-8 flex md:flex-row flex-col justify-between bg-[#FFFFFF] rounded-lg">
      ...
      <div className="flex-col items-center justify-center p-4 my-8 mx-auto">
      ...
      <div className="">
      <div className=" flex-col justify-between pl-4 pr-6 text-[#074786] w-[232px]">
            <div className="bg-[#F3F9FF] flex-col w-[135px] p-4 rounded-b-lg align-middle items-center justify-center mx-auto">
            <p className=" flex justify-center text-[32px]">9.1</p>
            <p className="my-1 flex justify-center text-[14px]">Very Good</p>
            <div className="flex justify-center">
              <img className="my-1 " src={star3} alt="star1" />
            </div>
          </div>
